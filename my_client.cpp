...
//    sched.wait();
    ...
    tcp::resolver::query query(argv[1], "10013");
//    tcp::resolver::iterator endpoint_iterator = resolver.resolve(query);
    resolver.resolve_async(query, on_resolve);

    void on_resolve(tcp::resolver::iterator &endpoint_iterator) {
    ...
    socket.async_read(buffer, on_read);
